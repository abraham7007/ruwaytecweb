...
import nuxt_plugin_plugin_3223a81a from 'nuxt_plugin_plugin_3223a81a' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_14679cc5 from 'nuxt_plugin_bootstrapvue_14679cc5' // Source: .\\bootstrap-vue.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"Virtuf","titleTemplate":"%s || RUWAY TEC","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_3223a81a === 'function') {
    await nuxt_plugin_plugin_3223a81a(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_14679cc5 === 'function') {
    await nuxt_plugin_bootstrapvue_14679cc5(app.context, inject)
  }
